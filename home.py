...
class ContractData(ctk.CTkFrame):
    def __init__(self, parent):
        ...
        self.frame_line_4.grid_columnconfigure((0,1,2,3), weight=1)
        self.company = ctk.CTkEntry(self.frame_line_4, width=100, placeholder_text='Empresa')
        self.company.grid(row=0, column=0, padx=20, pady=20)
        self.subject = ctk.CTkEntry(self.frame_line_4, width=100, placeholder_text='Disciplina')
        self.subject.grid(row=0, column=1, padx=20, pady=20)
        self.cat = ctk.CTkEntry(self.frame_line_4, width=100, placeholder_text='Cat')
        self.cat.grid(row=0, column=2, padx=20, pady=20)
        self.weekly_classes = ctk.CTkEntry(self.frame_line_4, width=100, placeholder_text='Aulas semanais')
